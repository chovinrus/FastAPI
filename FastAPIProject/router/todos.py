...
@todos_router.get('/todos/{id}', response_model=Todo)
async def get_todo(
...
@todos_router.put('/todos/{id}', response_model=Todo)
...
@todos_router.delete('/todos/{id}', response_model=Todo)
...
@todos_router.post('/todos/', response_model=Todo, status_code=201)
